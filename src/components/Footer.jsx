const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Ali-Ashraf-510',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ali-ashraf-8b619b22a',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="flex items-start gap-2 text-gray-400 dark:text-gray-500">
                ...
                <a href="mailto:aliabofooda1234@gmail.com" className="hover:text-primary-400 transition-colors">
