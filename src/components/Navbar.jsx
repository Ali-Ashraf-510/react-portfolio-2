...
/**
 * Navbar Component - Main navigation header with skip link for accessibility
 */
const Navbar = () => {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="absolute top-0 left-0 z-40 px-4 py-2 bg-primary-600 text-white font-medium
        ...
        <div className="container-custom">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden flex items-center gap-2">
              <button
                onClick={toggleMenu}
                className="inline-flex items-center justify-center p-2 rounded-lg text-gray-700 
