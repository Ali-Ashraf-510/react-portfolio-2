        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 items-center">
          ...
          <div className="flex flex-col justify-center animate-fade-in space-y-6">
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="p-3 bg-primary-100 dark:bg-primary-900 rounded-full">
                  <svg className="w-6 h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <span className="text-gray-700 dark:text-gray-200 font-medium">{profile.email}</span>
              </div>
              <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow">
          ...
          <div className="mb-20 animate-fade-in">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              {profile.experience.map((exp, index) => (
                <div key={index} className="card hover:shadow-lg transition-shadow border-l-4 border-primary-600 dark:border-primary-500">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-gray-50">{exp.title}</h3>
                    <span className="badge-primary">
                      {exp.period}
                    </span>
                  </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              {profile.education.map((edu, index) => (
                <div key={index} className="card hover:shadow-lg transition-shadow border-l-4 border-accent-600 dark:border-accent-500">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-accent-600 dark:text-accent-400 font-medium mb-2">{edu.school}</p>
